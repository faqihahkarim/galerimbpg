...
<nav class="navbar">
  ...
  <div class="logo">
    <img src="<?= $root ?>/assets/images/logombpg.png" alt="Logo MBPG">
    <img src="<?= $root ?>/assets/images/logogaleri.png" alt="Logo Galeri">
    <span>Galeri Seramik Pasir Gudang</span>
      ...
      <div class="menu-wrapper">
        <ul class="nav-links">
          ...
          <li><a href="<?= $base ?>/index.php#activity-section">Aktiviti</a></li>
          <li><a href="<?= $base ?>/index.php#package-section">Pakej</a></li>
        ...
        <div class="nav-action">
          ...
          <?php else: ?>
            ...
            <a href="<?= $base ?>/login.php" class="btn-primary">Admin</a>
