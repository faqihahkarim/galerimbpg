...
<body>
  ...
  <div class="detail-banner" style="background-image: url('../assets/images/act1.jpg');">
    <div class="detail-overlay">
      <div class="detail-content">
        <h1>Interaktif Mewarna</h1>

        <p>
          Mewarna produk seramik yang telah siap dibakar mengikut kreativiti para pengunjung
        </p>

        <div class="detail-info">
          <span><i class="fa-regular fa-clock"></i> 2–3 Jam</span>
          <span><i class="fa-solid fa-bullseye"></i> Sekolah Rendah</span>
          <span><i class="fa-solid fa-people-group"></i> 20 Orang</span>
          <span><i class="fa-solid fa-dollar-sign"></i> RM 10.00</span>
        </div>
      </div>
    </div>
  </div>
