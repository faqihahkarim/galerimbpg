...
<body>
  ...
  <div class="detail-banner" style="background-image: url('../assets/images/act2.jpg');">
    <div class="detail-overlay">
      <div class="detail-content">
        <h1>Melukis dan Mewarna</h1>

        <p>
          Mempelajari tentang teknik asas melukis motif dan pewarnaan asas seramik
        </p>
        ...
        <div class="detail-info">
          ...
          <span><i class="fa-solid fa-dollar-sign"></i> RM 15.00</span>
        </div>
      </div>
    </div>
  </div>
