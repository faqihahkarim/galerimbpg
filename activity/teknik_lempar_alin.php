...
<body>
  ...
  <div class="detail-banner" style="background-image: url('../assets/images/act4.jpg');">
    <div class="detail-overlay">
      <div class="detail-content">
        <h1>Teknik Lempar Alin</h1>

        <p>
          Mempelajari teknik membentuk menggunakan mesin roda tembikar 
        </p>

        <div class="detail-info">
          <span><i class="fa-regular fa-clock"></i> 2–3 Jam</span>
          <span><i class="fa-solid fa-bullseye"></i> Sekolah Menengah / Universiti / Dewasa</span>
          <span><i class="fa-solid fa-people-group"></i> 10 Orang</span>
          <span><i class="fa-solid fa-dollar-sign"></i> RM 30.00</span>
        </div>
      </div>
    </div>
  </div>
